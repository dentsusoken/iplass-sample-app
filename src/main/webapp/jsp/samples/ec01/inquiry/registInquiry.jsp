...
<div class="row">
    ...
    <div class="col-12">
        <span class="h4">${m:esc(m:rs('iplass-wtp-messages', 'samples.ec01.inquiry.regist.title'))} </span>
            ...
            <div class="form-group mt-4">
                <div class="col-12 text-center">
                    <button type="submit" class="btn btn-dark">
                    	${m:esc(m:rs('iplass-wtp-messages', 'samples.ec01.inquiry.regist.doRegist'))}
                    </button>
                </div>
            </div>
        </form>
